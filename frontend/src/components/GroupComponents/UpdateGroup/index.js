        ...
        <div className="newGroupSubDiv">
          ...
          <form onSubmit={handleSubmit}>
            <div>
              ...
              <h4>
                Meetup groups meet locally, in person and online. <br></br>We'll
            ...
            <div>
              ...
              <h4>
                ...
                group is about. <br></br>Feel free to get creative! You can edit
            ...
            <div>
              ...
              <h4>
                Add an image url below if you'd like to change your groups image
              </h4>
              <input
                type={`text`}
            ...
            <button type="submit" className="newGroupSubmitButtom">
              Update Group
            </button>
          </form>
        </div>
