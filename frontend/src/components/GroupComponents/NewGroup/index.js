...
function NewGroupForm() {
  ...
  const submitButtonClass = disableSubmitButton
        ...
        <form onSubmit={handleSubmit}>
            ...
            {/* {key && (
              <GoogleAutocomplete
                ...
                onPlaceSelected={(place) =>
                  setCity(place.address_components[0].long_name.split(", ")[0])
                }
                types={["(cities)"]}
                required
                placeholder="City"
          ...
          <div>
            ...
            <h5>
              ...
              is about. <br></br>Feel free to get creative! You can edit this
