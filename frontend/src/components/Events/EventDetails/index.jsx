...
import PrivateEventComponent from "./PrivateEvent";
  ...
  return (
    <div>
      {event.Group?.previewImage && event?.previewImage == undefined && (
        <PrivateEventComponent event={event} />
      )}
      {loaded && event?.previewImage !== undefined && (
        <div className="mainGroupDetailsDiv">
          ...
          <div className="eventDetailsGreySection">
            <div className="eventDetailsGreySectionTopHalf">
              <img
                id="eventDetailsImageId"
                className="eventDetailsImage"
